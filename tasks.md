...
- [ ] **E15-S1 · `.torrent` file association + `magnet:` URL scheme** — deep-link plugin + fileAssociations; opening either routes into the add dialogs (or instant-add per prefs).
